        ...
        <>
            <Box
                ...
                sx={{
                    ...
                    color: "white",
                    overflow: "hidden",
                    position: "fixed",  // הוספת מאפיין להצמדות לחלק העליון
                    top: 0,  // לוודא שה-header יהיה בראש
                    width: "100%",  // להבטיח שהרוחב יהיה 100%
                    zIndex: 10,  // לוודא שהתוכן מעל שאר התוכן
                }}
            >
                    ...
                    <AppBar position="static" sx={{ bgcolor: "#0d47a1", padding: 1, width: "100%" }}>
                        <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%" }}>
                            ...
                            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 1 }}>
                                ...
                                {/* כאן הוספנו את היכולת ללחוץ על שם האפליקציה כדי לנתב לעמוד הבית */}
                                <Typography
                                    variant="h6"
                                    fontWeight="bold"
                                    sx={{ cursor: "pointer" }}
